...
driver.get("https://vtc.vn/giao-duc-31.html")



with open('vtcGiaoduc.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,15):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"giáo dục","vtc.vn",time])
    # sleep(2)
