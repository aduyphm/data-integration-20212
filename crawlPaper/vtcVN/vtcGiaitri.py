...
driver.get("https://vtc.vn/giai-tri-33.html")



with open('vtcGiaitri.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,15):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"giải trí","vtc.vn",time])
    # sleep(2)
