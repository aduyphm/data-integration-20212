...
driver.get("https://vtc.vn/the-thao-34.html")



with open('vtcThethao.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,15):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"thể thao","vtc.vn",time])
    # sleep(2)
