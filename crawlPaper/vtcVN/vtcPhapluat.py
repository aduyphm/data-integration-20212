...
driver.get("https://vtc.vn/phap-luat-32.html")



with open('vtcPhapluat.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,15):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"pháp luật","vtc.vn",time])
    # sleep(2)
