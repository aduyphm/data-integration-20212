...
driver.get("https://kienthuc.net.vn/kinh-doanh/")



with open('kienthucKinhte.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,10):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"kinh tế","kienthuc.net",time])
    # sleep(2)
