...
driver.get("https://kienthuc.net.vn/the-gioi/")



with open('kienthucTG.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,10):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"thế giới","kienthuc.net",time])
    # sleep(2)
