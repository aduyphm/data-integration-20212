...
driver.get("https://kienthuc.net.vn/khoa-hoc/")



with open('kienthucKhoahoc.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,10):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"khoa học","kienthuc.net",time])
    # sleep(2)
