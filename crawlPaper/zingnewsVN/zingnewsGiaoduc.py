...
driver.get("https://zingnews.vn/giao-duc.html")



with open('zingnewsGiaoduc.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,1):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"giáo dục","zingnews.vn",time])
    # sleep(2)
