...
driver.get("https://zingnews.vn/the-thao.html")



with open('zingnewsThethao.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,1):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"thể thao","zingnews.vn",time])
    # sleep(2)
