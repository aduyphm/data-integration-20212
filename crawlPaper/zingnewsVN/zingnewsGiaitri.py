...
driver.get("https://zingnews.vn/giai-tri.html")



with open('zingnewsGiaitri.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,1):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"giải trí","zingnews.vn",time])
    # sleep(2)
