...
driver.get("https://zingnews.vn/the-gioi.html")



with open('zingnewsTG.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,1):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"thế giới","zingnews.vn",time])
    # sleep(2)
