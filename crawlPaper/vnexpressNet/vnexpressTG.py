...
driver.get("https://vnexpress.net/the-gioi")



with open('vnexpressTG.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,10):
    ...
    for post in posts:
      ...
      try:
        ...
        print(discrip)
        print("======================= \n\n")
        spamwriter.writerow([title,link,thumbnail,discrip,"thế giới","vnexpress.net","unknow"])
        dem +=1
      except:
        pass
