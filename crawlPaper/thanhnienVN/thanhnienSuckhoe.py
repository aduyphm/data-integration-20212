...
driver.get("https://thanhnien.vn/suc-khoe/")



with open('thanhnienSuckhoe.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"sức khỏe","thanhnien.vn",time])
    # sleep(2)
