...
driver.get("https://thanhnien.vn/giao-duc/")



with open('thanhnienGiaoduc.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"giáo dục","thanhnien.vn",time])
    # sleep(2)
