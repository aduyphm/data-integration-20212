...
driver.get("https://thanhnien.vn/the-gioi")



with open('thanhnienTG.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"thế giới","thanhnien.vn",time])
    # sleep(2)
