...
driver.get("https://thanhnien.vn/doi-song/")



with open('thanhnienDoisong.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"đời sống","thanhnien.vn",time])
    # sleep(2)
