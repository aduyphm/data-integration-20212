...
driver.get("https://laodong.vn/suc-khoe/?page=1")



with open('laodongSuckhoe.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,15):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"sức khỏe","laodong.vn",time])
    # sleep(2)
