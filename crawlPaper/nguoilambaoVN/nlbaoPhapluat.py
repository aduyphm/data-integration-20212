...
driver.get("http://nguoilambao.vn/phap-luat/")



with open('nlbaoPhapluat.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"pháp luật","nguoilambao.vn",time])
    # sleep(2)
