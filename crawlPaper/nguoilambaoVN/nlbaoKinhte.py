...
driver.get("http://nguoilambao.vn/kinh-te/")



with open('nlbaoKinhte.csv', 'w', newline='',encoding='utf-8') as csvfile:
  ...
  for page in range(0,12):
    ...
    for i in range(0,len(t1)):
      ...
      spamwriter.writerow([title,link,thumbnail,discrip,"kinh tế","nguoilambao.vn",time])
    # sleep(2)
